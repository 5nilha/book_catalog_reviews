...
b11 = Book.create(title: "Take me there", author: "Susane Colasanti", description: "The ups and downs of love and relationship.", publisher: "Speak", weeks_on_list: "22", rank_this_week: 13)
...
Review.create(comment: "Each character's voice is strong, and the dialogue is stolen right from the corridors of a contemporary high school", author: "Booklist", book_id: b11.id)
Review.create(comment: "Insightful, humorous, moving ... Colasanti's characters will feel like they're your best friends by the time you have finished this delightful novel", author: "The Compulsive Reader", book_id: b11.id)
